    ...
    <>
      ...
      <div className="min-h-screen bg-terminal-bg pt-24 pb-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="flex items-center font-mono text-sm border border-hacker-green/30 rounded bg-terminal-bg px-3 py-2">
              <span className="text-hacker-green/60 mr-2">grep</span>
              <input
                value={search}
                onChange={e => setSearch(e.target.value)}
                placeholder="search articles..."
                className="bg-transparent flex-1 outline-none text-hacker-green placeholder:text-hacker-green/30"
              />
            </div>
          </motion.div>
