  ...
  return (
    <motion.header
      ...
      className={cn(
        ...
        isTransparent
          ? 'bg-transparent'
          : 'bg-white/[0.03] dark:bg-white/[0.03] backdrop-blur-xl backdrop-saturate-150 border-b border-white/[0.08] shadow-[0_8px_32px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.06)]'
      )}
    >
